...
class UpdateSpecialtyTest extends TestCase
{
     ...
     * @return TestResponse
     */
    private function makeRequest(?User $agent, array $params = [], $specialtyId = null): TestResponse
    {
        $uri = route('specialty.update', ['specialty' => !($specialtyId) ? $this->specialty->id : $specialtyId]);
