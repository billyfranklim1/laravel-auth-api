...
class DeleteSpecialtyTest extends TestCase
{
     ...
     * @return TestResponse
     */
    private function makeRequest(?User $agent, $specialtyId = null): TestResponse
    {
        $uri = route('specialty.destroy', ['specialty' => !($specialtyId) ? $this->specialty->id : $specialtyId]);
