...
class UpdateBloodTypeTest extends TestCase
{
     ...
     * @return TestResponse
     */
    private function makeRequest(?User $agent, array $params = [], $bloodTypeId = null): TestResponse
    {
        $uri = route('blood-type.update', ['blood_type' => !($bloodTypeId) ? $this->bloodType->id : $bloodTypeId]);
