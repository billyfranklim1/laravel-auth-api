...
class UpdateAntibioticTest extends TestCase
{
     ...
     * @return TestResponse
     */
    private function makeRequest(?User $agent, array $params = [], $antibioticId = null): TestResponse
    {
        $uri = route('antibiotic.update', ['antibiotic' => !($antibioticId) ? $this->antibiotic->id : $antibioticId]);
